  ...
  <div class="container">
    ...
    <div class="carousel reveal">
      ...
      <div class="cards-track" id="destTrack">
        <article class="dest-card" style="background-image:url('img/bromo.jpg')">
          <div class="shade"></div>
        ...
        <article class="dest-card" style="background-image:url('img/temple.jpg')">
          <div class="shade"></div>
        ...
        <article class="dest-card" style="background-image:url('img/hills.jpg')">
          <div class="shade"></div>
        ...
        <article class="dest-card" style="background-image:url('img/ijen.jpg')">
          <div class="shade"></div>
  ...
  <div class="container">
    ...
    <div class="tours-grid">
      <article class="tour-card reveal">
        <div class="tour-media" style="background-image:url('img/bromo.jpg')"><span class="badge">3D 2N</span></div>
        <div class="tour-body">
      ...
      <article class="tour-card reveal">
        <div class="tour-media" style="background-image:url('img/temple.jpg')"><span class="badge">4D 3N</span></div>
        <div class="tour-body">
      ...
      <article class="tour-card reveal">
        <div class="tour-media" style="background-image:url('img/waterfall.jpg')"><span class="badge">5D 4N</span></div>
        <div class="tour-body">
      ...
      <article class="tour-card reveal">
        <div class="tour-media" style="background-image:url('img/hills.jpg')"><span class="badge">Customize</span></div>
        <div class="tour-body">
    ...
    <div class="center-cta"><a class="btn btn-primary" href="#">View All Tours</a></div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="blog-grid">
      <article class="blog-card reveal">
        <div class="blog-media" style="background-image:url('img/bromo.jpg')"></div>
        <div class="blog-body">
      ...
      <article class="blog-card reveal">
        <div class="blog-media" style="background-image:url('img/temple.jpg')"></div>
        <div class="blog-body">
      ...
      <article class="blog-card reveal">
        <div class="blog-media" style="background-image:url('img/waterfall.jpg')"></div>
        <div class="blog-body">
      ...
      <article class="blog-card reveal">
        <div class="blog-media" style="background-image:url('img/hills.jpg')"></div>
        <div class="blog-body">
